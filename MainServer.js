...
if ( typeof Deno == 'undefined' && typeof process != 'undefined' && process.versions?.node ) { // Deno might be having 'process' var defined for Node.js compatibility. So check for Deno object absense.
