import { BlobServer, CheckIfExists, CorsProxy, Serve, DatabaseDeletionPreventionCRONJob as CronJob, DeleteLink, DeleteNote, FyersToken, GetLink, GetM3U8, GetNote, JSNotebook, LoginHandler, ProtectedRoute, SaveLink, SaveNote, ServeStaticFile, TgChannels, } from './Functions.js';
...
// For testing purposes without 'dotenv' module export env variables in terminal. ( export USERNAME=yourusername PASSWORD=yourpassword JWT_SECRET=yourjwtsecret ).
// node --watch MainServer.js
